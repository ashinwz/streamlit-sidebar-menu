        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    ...
                    <span class="profession">Made by AIDD</span>
                </div>
            </div>

            <i class='bx bx-chevron-right toggle' id="toggle-bar" @click="onClicked(-1, -1)"></i>
        </header>
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link" v-for="(option,i) in args.options" :key="option">
                        ...
                        @click="onClicked(i, option)" aria-current="page">
                            <i class="bx icon" :class="icons[i]"></i>
